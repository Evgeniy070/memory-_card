...
def question_list():
    ...
    frm = Question("Яблоко2", "Apple2", "Tomato2", "Carrot2", "Orange2")
    questions_listmodel.form_list.append(frm)
    frm = Question("Яблоко3", "Apple3", "Tomato3", "Carrot3", "Orange3")
    questions_listmodel.form_list.append(frm)
    frm = Question("Яблоко4", "Apple4", "Tomato4", "Carrot4", "Orange4")
    questions_listmodel.form_list.append(frm)
    frm = Question("ВОПРОС", "ПРАВИЛЬНЫЙ ОТВЕТ", "НЕПРАВИЛЬНО1", "НЕПРАВИЛЬНО2", "НЕПРАВИЛЬНО3")
    questions_listmodel.form_list.append(frm)
